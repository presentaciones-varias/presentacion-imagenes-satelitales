...
::: {.incremental .medium-par}
- [Podemos aprovechar el potencial que tiene la **combinación de imágenes satelitales y machine learning (ML)** para enriquecer el cálculo de indicadores estadísticos, superando los **desafíos** planteados:]{style="color:gray;"}
